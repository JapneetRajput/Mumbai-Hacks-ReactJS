          ...
          {posts &&
            posts.map(
              ({
                ...
                <div className="w-86 self-center pt-10 bg-[#0D1117] border-2 border-[#272e38]  rounded-lg shadow   cursor-pointer  mb-5 ml-2 mr-2 hover:bg-[#212833] duration-300">
                  <div
                    style={{
                      marginLeft: "5%",
                      marginRight: "5%",
                  ...
                  >
                    ...
                    <div className="px-6 py-4 ">
                      ...
                      <input
                        type="radio"
                        name="hs-radio-group"
                        class=" mt-0.5 border-gray-200 rounded-full text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                        id="hs-radio-group-1"
                        checked
                      />
                      <label
