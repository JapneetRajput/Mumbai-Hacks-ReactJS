  ...
  return (
    <>
      ...
      blogs.map(({_id, title, description, street, city, country, user_id}) => (
              ...
              >
                <img src={BB} alt="" className=" self-center rounded-t-lg object-contain w-40 h-40 md:rounded-none md:rounded-l-lg inline" />
                <div className="px-6 py-4 ">
                  <div className="flex flex-col justify-between p-4 leading-normal">
                  <h5 class="mb-2 text-2xl font-semibold uppercase tracking-tight text-white"> Title : {title}</h5>
                    <br />
                    <p class="mb-3 font-medium text-[#c9d1d9] grid grid-row-3">Description : {description}
                    <br /> 
                    <br/>
                    Street: {street} <br/>
                    City: {city} <br/>
