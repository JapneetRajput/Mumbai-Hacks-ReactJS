    ...
    >
      <label className={`relative cursor-text ${props.width}`}>
        <textarea
          ...
          className={`${props.input} ${props.height} ${props.width} ${props.text} ${props.backgroundColor} ${props.border} pt-2 rounded-lg border-opacity-50 outline-none focus:border-[#2E0052] placeholder-gray-300 placeholder-opacity-0 transition duration-200`}
        />
        <span
